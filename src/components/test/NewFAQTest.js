...
import UpdateFAQTest from '../test/UpdateFAQTest.js';
...
class NewFAQTest extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
 ...
 <UpdateFAQTest currentEdit={this.state.currentEdit} handleEditItem={this.handleEditItem}/>
  </>
):(
<>
