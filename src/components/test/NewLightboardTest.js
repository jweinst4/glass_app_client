...
import UpdateLightboardTest from '../test/UpdateLightboardTest.js';
...
class NewLightboardTest extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            name: '',
 ...
 <UpdateLightboardTest currentEdit={this.state.currentEdit} handleEditItem={this.handleEditItem}/>
  </>
):(
<>
...
export default NewLightboardTest
